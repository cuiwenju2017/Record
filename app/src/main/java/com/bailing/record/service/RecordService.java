...
import com.bailing.record.acivity.MainActivity;
...
public class RecordService extends Service {
    ...
    private void doStartRecording(String path) {
        Log.v(TAG, "doStartRecording path: %s" + path);
...
//        builder.setContentIntent(pIntent);// 将意图设置到通知上
        ...
        remoteViews.setImageViewResource(R.id.remoteview_icon, R.mipmap.ic_launcher);
